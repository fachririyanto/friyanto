            ...
            <div className="container">
                <div className="flex">
                    <div className="w-[340px] min-w-[340px] text-center">
                        <figure className="mx-auto max-w-[200px] rounded-full border border-black">
                    ...
                    <div className="flex-grow pt-8 pl-14 text-xl leading-relaxed">
                        <div className="max-w-[640px]">
                            ...
                            <p>My tech stack is WordPress, PHP/Laravel, MySQL, JavaScript (Vanilla, jQuery, ReactJS, NextJS), HTML5 & CSS3 (Native, SASS, Bootstrap, Tailwind), and Docker.</p>
                        </div>
                    </div>
                </div>
            </div>
